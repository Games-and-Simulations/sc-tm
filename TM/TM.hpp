...
struct TournamentModuleManager {
    ...
    void writeResults() {
        ...
        if (of.is_open()) {
            ...
            printVar(of, "is_crashed", boolname(win_reason == WinReason::Crash), ",");
#elif BWAPI3
            printVar(of, "is_winner", boolname(winner == Self), ",");
            printVar(of, "is_crashed", boolname(win_reason == Crash), ",");
#endif
...
#ifdef BWAPI4
        win_reason = WinReason::Eliminated;
        winner = didWin ? Winner::Self : Winner::Enemy;
#elif BWAPI3
        win_reason = Eliminated;
...
#ifdef BWAPI4
    WinReason win_reason = WinReason::Crash;
